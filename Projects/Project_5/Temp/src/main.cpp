...
//                     if (startRegister == 1 && endRegister != 1 | startRegister != 1 && endRegister == 1){
//                         response[2] = 0x02;
//                     }
//                     uint16_t sentCRC = ModRTU_CRC(response, 3);
//                     response[3] = (uint8_t)(sentCRC & 0xFF);    // Store the low byte of the CRC
//                     response[4] = (uint8_t)((sentCRC >> 8) & 0xFF); // Store the high byte of the CRC
...
//                     response[2] = 0x01;
//                 }
//                 else if (startRegister != 1 && endRegister != 1){
//                     response[2] = 0x02;
//                 }
//                 uint16_t sentCRC = ModRTU_CRC(response, 3);
//                 response[3] = (uint8_t)(sentCRC & 0xFF);    // Store the low byte of the CRC
