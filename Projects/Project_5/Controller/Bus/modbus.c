...
//         if (ServerAddress == 1 && Command == WRITE_SINGLE_REGISTER) {
//             printf("prump\n");
//             createModbusMessage(modbusSendBuffer, ServerAddress, Command, RegisterAddress, Value);
...
//             // uint16_t recievedCRC = ((uint16_t)modbusRecieveBuffer[5] << 8) | modbusRecieveBuffer[4];
//             // if(recievedCRC == ModRTU_CRC(modbusRecieveBuffer,4)){
//             //     printf("Modbus Received Message: ");
//             //     for (int i = 0; i < 4; i++) {
//             //         printf("%02X ", modbusRecieveBuffer[i]);
//             //     }
//             //     printf("%02X ", modbusRecieveBuffer[5]);
//             //     printf("%02X ", modbusRecieveBuffer[4]);                
//             //     printf("\n");
//             // }

//         }
//         // else if (ServerAddress == 1 && Command !=  READ_HOLDING_REGISTERS)
//         // {
...
//         //     }
//         //     usleep(10000);
//         //     if ((count = read(file, (void*)modbusRecieveBuffer, 5))<0){
//         //         perror("Failed to read from the input\n");
//         //         return -1;
//         //     }
